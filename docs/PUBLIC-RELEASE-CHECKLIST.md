...
This checklist separates the current review snapshot from the final public
release used in a submission.

- [x] Manuscript and supplementary PDFs included.
- [x] Source manuscript, references, figures, configs, canonical summaries,
      and selected raw JSON artifacts included.
