...
> Analysis code, frozen configuration files, canonical machine-readable result
...
> summaries and derived tables; access to any restricted raw material is subject
> to the applicable data terms.

If a later release adds the raw semantic matrix, update this statement to name
the exact path and file format.
